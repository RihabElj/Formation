...
public class PageFormulaire {
	...
	@FindBy(how=How.ID,using="//select[@id='days']")
	public static WebElement Day;
	
	@FindBy(how=How.ID,using="//select[@id='months']")
	public static WebElement Month;
	
	@FindBy(how=How.ID,using="//select[@id='years']")
	...
	@FindBy(how=How.NAME,using="Adress1")
	public static WebElement Adress1;
	
	@FindBy(how=How.NAME,using="Adress2")
	...
	public void clique_newsletter() {
		newsletter.click();
	}
	public void clique_Offer() {
		Offer.click();
	}
	
	public void clique_create_button() {
		create_button.click();
	}
...
public void saisir_Pass(Object string) {
